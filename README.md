...
```  
Получить гифку  
(пример ответа: https://api.giphy.com/v1/gifs/random?api_key=R8v094I52qdocCM1aP0lgCbArWHlmQ75&tag=rich):
```
...
```  
docker build usd_checker_image:gg .  
```
Запуск:   
```
docker run -p 8080:8080 usd_checker_image:gg 
